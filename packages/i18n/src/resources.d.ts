...
export default interface Resources {
  "app": {
    ...
    "agentPrompts": {
      ...
      "descriptions": {
        ...
        "builtinTemplates": "These templates are provided by agi and cannot be modified.",
    ...
    "agents": {
      ...
      "bundleManagedHint": "agi manages the bundle automatically.",
    ...
    "backend": {
      ...
      "connectionError": "Can't reach the agi backend",
      "couldNotLoad": "agi couldn't load your projects right now. Please make sure the backend is running and try again.",
      "error": "Error: {{error}}",
    ...
    "chat": {
      ...
      "maximizeToChatView": "Open in Chat view",
      ...
      "minimizeToQuickChat": "Minimize to quick chat",
      "newChat": "New Chat",
    ...
    "cli": {
      "installBody": "Get the {{fn}} and {{fusion}} commands on your terminal so you can drive agi from anywhere. One click below or copy the command into your shell.",
      "installButton": "Install with npm",
      "installTitle": "Install the agi CLI",
      "installing": "Installing…",
      "openSettings": "Open Settings",
      "updateButton": "Update with npm",
      "updateTitle": "Update the agi CLI",
      "updating": "Updating…",
    ...
    "commandCenter": {
      ...
      "github": {
        ...
        "net": "Net",
        "openResolvedIssue": "Open GitHub issue {{issue}}",
        "repoValue": "{{filed}} filed / {{fixed}} fixed",
        "resolvedApprox": "approx",
        "resolvedAt": "Resolved at",
        "resolvedAtUnknown": "Unknown",
        "resolvedIssue": "Issue",
        "resolvedTask": "Resolving task",
    ...
    "dashboard": {
      ...
      "updatingMessage": "Updating agi dashboard",
      "updatingVersion": "Updating to a new frontend version..."
    },
    "dbBanner": {
      "body": "agi's background SQLite integrity check reported corruption. Review the failing objects below before continuing critical operations.",
    ...
    "desktop": {
      "chooseMode": "How do you want to run agi?",
      "chooseModeDescription": "Run agi locally in this app, or connect to a agi server you're already running somewhere else.",
      "connectRemoteButton": "Connect to Remote agi",
      "couldNotStart": "Couldn't start local agi",
      "loading": "Loading agi…",
      "opening": "Opening…",
      "retry": "Retry",
      "runLocalButton": "Run agi Locally",
      "settingUpRemote": "Setting up remote connection…",
      "starting": "Starting…",
      "startingLocalRuntime": "Starting local agi runtime…"
    },
    "devserver": {
      ...
      "newLogs": "New logs",
      "noExecutingTasks": "No executing tasks with a worktree available. Start a task to target its worktree.",
      ...
      "previewModalLauncherDescription": "Open the live preview in a modal so logs and configuration stay usable in this narrow dock.",
      "previewModalLauncherUnavailable": "Start the dev server or set a preview URL to open the preview modal.",
      "previewUrlOverride": "Preview URL Override",
      "projectRootNoTask": "Project root (no task)",
      "refreshPreview": "Refresh preview",
      "restart": "Restart",
      "restartToApplyTask": "Restart the dev server to apply the selected task's worktree.",
    ...
    "engineUnavailable": {
      "body": "This dashboard can display project data, but task automation will not run until you restart agi with the engine. Stop this server and run <sourceCmd>pnpm local</sourceCmd> from a source checkout, or <cliCmd>agi dashboard</cliCmd> from an installed CLI.",
      "title": "AI engine is not running"
    },
    "errorBoundary": {
    ...
    "fileViewer": {
      "back": "Back to files",
      "popOut": "Open in resizable window",
    ...
    "git": {
      ...
      "advancesHelpFix": "<strong>Fix:</strong> agi only shows <em>Sync working tree</em> when at least one advance is genuinely <code>pending</code> and HEAD is not aligned with the integration tip. If entries are already handled (subsumed/orphaned/reachable/superseded), no sync action is offered.",
      "advancesHelpIntro": "Each entry is a agi task whose squash commit advanced the integration branch ref (<branchCode>{{integrationBranch}}</branchCode>). The <em>auto-sync outcome</em> says whether your working tree was also fast-forwarded to that new tip.",
      ...
      "closeIssueTitle": "Close issue #{{number}}",
      ...
      "issueClosedToast": "Issue #{{number}} closed",
    ...
    "githubStarPrompt": {
      "body": "If agi has saved you time, a GitHub star goes a long way. It helps other developers discover the project and keeps the team motivated to ship improvements.",
    ...
    "health": {
      ...
      "anomalyBody": "agi found allocator state that can cause task IDs to be reused or overwrite live task records.",
    ...
    "hermes": {
      ...
      "description": "Drives the local {{cmd}} CLI as a subprocess. Each agi prompt is sent as {{chatCmd}}; subsequent prompts resume the same hermes session via {{resumeFlag}}. Provider, model, and skills are configured inside hermes itself; this card only chooses overrides.",
      ...
      "timeoutHelp": "agi-side hard cap. Default 5 min.",
    ...
    "listView": {
      ...
      "loadingWorkflowLanes": "Loading workflow lanes",
      "newTask": "+ New Task",
      "noChange": "No change",
      "noTasks": "No tasks",
      "noTasksMatch": "No tasks match your filter",
      "noTasksYet": "No tasks yet",
      "noWorkflowLanes": "No workflow lanes available",
    ...
    "merge": {
      ...
      "commit": "Commit",
      "disabledMergeLocked": "Push paused — a agi merge is in progress.",
    ...
    "missions": {
      ...
      "autopilotDescription": "When on, agi automatically activates the next slice and plans its features as work completes.",
    ...
    "nodes": {
      ...
      "description": "Register an existing agi node by providing its connection details and concurrency settings.",
    ...
    "onboarding": {
      ...
      "description": "agi helps you plan, run, and review AI-assisted engineering work.",
      "localFusion": "Local agi",
    ...
    "openclaw": {
      ...
      "description": "Drives the local <code1>openclaw</code1> CLI as a subprocess. Each agi prompt is dispatched via <code2>openclaw agent --local --json</code2>; the agent definition, model, and thinking level are resolved by OpenClaw. This card only sets overrides and the binary path.",
      ...
      "subprocessHint": "agi-side hard cap before the CLI subprocess is killed (default: {{default}}s).",
      "testFailed": "Test failed — see status above.",
      "thinking": "Thinking level",
      "thinkingHint": "Controls how much extended thinking the model uses."
    },
    "paperclip": {
      "agentHelp": "Pick the Paperclip agent this agi runtime will proxy.",
      "agentLabel": "Agent",
      ...
      "resolved": "resolved",
      "runTimeoutHelp": "Local cap before agi gives up on a Paperclip run.",
    ...
    "piManager": {
      ...
      "reinstallButton": "Reinstall agi skill",
      "reinstallFailed": "Failed to reinstall agi skill: {{error}}",
      "reinstallSuccess": "agi skill reinstalled successfully",
      "reinstalling": "Reinstalling agi…",
    ...
    "planning": {
      ...
      "remove": "Remove",
      "resizeSidebar": "Resize planning sidebar",
    ...
    "plugins": {
      ...
      "droidRecommendDesc": "Use your local Droid CLI session as an AI provider in agi.",
      ...
      "registryDescription": "Discover curated runtimes and integrations that can be added to this agi workspace.",
    ...
    "pr": {
      ...
      "pushBranch": {
        ...
        "message": "agi will push this task's branch to origin so the PR can be created.",
      ...
      "resolveConflicts": {
        ...
        "message": "agi will use AI to resolve conflicts on this branch and push it.",
    ...
    "schedule": {
      ...
      "selectAutomationHint": "Choose an automation from the list to view its details.",
    ...
    "settings": {
      ...
      "general": {
        ...
        "quickChatLauncher": "Quick Chat launcher",
        "quickChatLauncherFloating": "Floating button",
        "quickChatLauncherFooter": "Footer button",
        "quickChatLauncherHint": "Choose whether Quick Chat opens from the draggable floating button, a footer button beside Terminal, or stays hidden.",
        ...
        "trackingIssuesUseThisTaskAposSTitle": " Tracking issues use this task's title. If a task has no title yet, agi can summarize its description using the title summarization model in Project Models. ",
        ...
        "updateSuccess": "Updated to v{{version}} — restart agi to apply",
        "updateSuccessToast": "Update installed. Restart agi to apply it.",
        "updating": "Updating…",
        ...
        "whenEnabledDefaultFusionSpawnsShortLived": " When enabled (default), agi spawns short-lived ",
        "whenEnabledFusionChecksOpenAndClosedIssues": " When enabled, agi checks open and closed issues in the target repo for likely duplicates (using File Scope paths and key symptoms) before creating a new tracking issue. Uncheck to always create a new issue. ",
      ...
      "globalGeneral": {
        ...
        "whenEnabledFusionChecksNpmForNewVersions": " When enabled, agi checks npm for new versions of",
      ...
      "globalModels": {
        ...
        "latency": "latency",
        "leaveEmptyToOmitThisHeaderDefaultFusion": "Leave empty to omit this header. Default: agi.",
      ...
      "merge": {
        ...
        "addFusionAsCoAuthorOnCommits": " Add agi as co-author on commits ",
        "afterFusionAdvancesTheIntegrationBranchRefThe": " After agi advances the integration branch ref, the merger can auto-sync other worktrees still checked out on that branch (typically your project-root checkout). ",
        ...
        "controlsWhatHappensAfterATaskReachesIn": " Controls what happens after a task reaches In Review. Direct mode merges into the current branch locally. Pull request mode keeps the task in In Review while agi waits for GitHub reviews and required checks before merging the PR. ",
        ...
        "theCanonicalBranchFusionMergesTasksIntoAnd": " The canonical branch agi merges tasks into and uses as the reference for all ahead/behind / overlap / pre-rebase computations. Leave on ",
        ...
        "trailer": " trailer",
        "trailerCreditingFusionRecognizedByGitHubForShared": " trailer crediting agi (recognized by GitHub for shared attribution). ",
        ...
        "whenEnabledCommitsMadeByFusionKeepYour": " When enabled, commits made by agi keep your git identity as the primary author and append a ",
      ...
      "modelPricing": {
        ...
        "delete": "Delete",
        "description": "Override per-1M token rates used by Command Center cost estimates. Overrides win over the built-in baseline; unlisted models still use the baseline.",
        "empty": "No model pricing overrides yet. Add one manually or fetch the latest LiteLLM prices.",
        "fetchFailed": "Failed to fetch latest model prices.",
        "fetchLatest": "Fetch latest prices",
        "fetchSuccess_one": "Fetched {{count}} model prices.",
        "fetchSuccess_other": "Fetched {{count}} model prices.",
        "fetching": "Fetching…",
        "input": "Input / 1M",
        "invalidKey": "Use a provider:model key before adding a pricing row.",
        "modelKey": "provider:model",
        "newCacheRead": "New cache read rate",
        "newCacheWrite": "New cache write rate",
        "newInput": "New input rate",
        "newKey": "New provider:model key",
        "newOutput": "New output rate",
        "newSource": "New source",
        "noFetchYet": "No fetched pricing snapshot yet.",
        "output": "Output / 1M",
        "overrides": "Model pricing overrides",
        "pricesAsOf": "Prices as of {{date}}",
        "saveHint": "Manual edits are saved with the rest of Global settings.",
        "source": "Source",
        "title": "Model pricing overrides"
      },
      "models": {
      ...
      "notifications": {
        ...
        "leaveBlankToPublishWithoutAuthenticationWhenSet": " Leave blank to publish without authentication. When set, agi sends an Authorization Bearer header with ntfy requests. ",
      ...
      "scope": {
        "globalBanner": "These settings are shared across all your agi projects.",
      ...
      "worktrees": {
        ...
        "disabledByDefaultOptInWhenEnabledFusion": " Disabled by default (opt-in). When enabled, agi shells out to ",
        ...
        "fallBackToFusionsNativeWorktreeBackend": "Fall back to agi's native worktree backend",
        ...
        "keepsProgressMovingBySwitchingToFusionApos": " keeps progress moving by switching to agi&apos;s built-in worktree backend. ",
        ...
        "optionalLeaveBlankToAutoResolveFusionWill": "Optional. Leave blank to auto-resolve; agi will offer to install on first use.",
        ...
        "worktreesPickerNote": "Navigate to the folder where agi should create task worktrees, then select the current directory.",
        "worktrunk": " worktrunk ",
    ...
    "setup": {
      ...
      "aiSetupDescription": "agi uses AI models to plan, write, and review code for you. Connect an AI provider below to get started — you can use a hosted service or enter an API key.",
      ...
      "cloneGitHint": "agi will run git clone into the destination directory, then register that cloned folder.",
      "cloneGitRepository": "Clone Git Repository",
      "clonePathHint": "Select or type an absolute destination path. agi will clone into this directory.",
      ...
      "completeSetup": "Complete these setup items to get the most out of agi.",
      "connect": "Connect",
      ...
      "connectRemoteServer": "Connect remote agi server",
      ...
      "createNewTaskSubtitle": "Describe what you need built; agi will spawn temporary task agents automatically",
      ...
      "firstAgentIntro": "Agents are optional. agi can build tasks without one by starting temporary agents for planning, coding, review, and merge. Create an agent only if you want help coordinating tasks and direction.",
      ...
      "howDoesLoginWorkBody": "Clicking Login opens the provider's website in a new tab where you sign in. Once you authorize agi, this page will automatically detect the connection. Your credentials are never stored in agi.",
      "importFromGitHub": "Import from GitHub",
      ...
      "noProvidersConfigured": "No AI providers are configured. Please check your agi configuration.",
      ...
      "welcomeToFusion": "Welcome to agi",
      "whatAreAiProviders": "What are AI providers?",
      "whatAreAiProvidersBody": "AI providers like OpenAI and Anthropic power the AI capabilities in agi. Connecting a provider lets agi's agents use AI models to help with your tasks.",
      ...
      "whatDoesProjectSetupDoBody": "Project setup registers a workspace so agi knows where to read files, run commands, and track task changes.",
      "whatHappensWhenCreateTask": "What happens when I create a task?",
      "whatHappensWhenCreateTaskBody": "Describe the work you want done. You can create tasks without an agent: agi starts temporary agents to plan, code, review, and merge. Track everything on the board.",
      "whatIsApiKey": "What is an API key?",
      "whatIsApiKeyBody": "An API key is a secret token that authenticates agi with the provider. You can find your key in the provider's dashboard under API settings. Keys are stored securely on your machine.",
    ...
    "skills": {
      ...
      "backToSkillMd": "Back to SKILL.md",
      ...
      "fileNotPreviewable": "This file cannot be previewed.",
      "filesLabel": "Files",
      "install": "Install",
      ...
      "selectASkill": "Select a skill to view its details",
      "title": "Skills",
    ...
    "subtasks": {
      ...
      "progressHint": "agi will keep working while the AI prepares subtasks.",
      "reconnecting": "Reconnecting…",
      "remove": "Remove",
      "retry": "Retry",
      "retrying": "Retrying...",
    ...
    "taskDetail": {
      ...
      "githubTracking": {
        ...
        "unlinkMessage": "This stops agi from syncing with the linked GitHub issue. The issue itself will not be modified.",
    ...
    "taskDocuments": {
      "artifactCount_one": "{{count}} artifact{{plural}}",
      "artifactCount_other": "{{count}} artifact{{plural}}",
      ...
      "documentCount_one": "{{count}} document{{plural}}",
      "documentCount_other": "{{count}} document{{plural}}",
    ...
    "taskForm": {
      ...
      "optionalStepsLoading": "Loading optional steps…",
    ...
    "tasks": {
      ...
      "workspace": "Workspace",
      "workspaceReposAcquired_one": "{{count}} repos acquired",
      "workspaceReposAcquired_other": "{{count}} repos acquired",
      "workspaceWorktrees": "Workspace repos"
    },
    "terminal": {
      ...
      "popOutTerminal": "Pop out terminal",
      ...
      "resizeDockedPanel": "Resize terminal panel",
      "resizeFloatingPanel": "Resize terminal window",
      "shortcuts": "Shortcuts",
    ...
    "theme": {
      ...
      "shadcnCustom": {
        "colorInput": "Pick {{label}} color",
        "description": "Override shadcn design tokens with hex colors. Blank tokens use the theme defaults.",
        "hexInput": "{{label}} hex color",
        "reset": "Reset custom colors",
        "title": "Custom shadcn colors"
      }
    },
    "todo": {
      ...
      "completedCount": "{{completed}}/{{total}} complete",
    ...
    "workflowNodes": {
      "advisory": "Advisory",
      "asOptionalGroup": "as optional group",
      ...
      "gateMode": "Gate mode",
      "helpConfigure": "Configure",
      "helpEdges": "Edges",
      "helpEngineManaged": "Engine-managed",
      "helpInputs": "Inputs",
      "helpOutputs": "Outputs",
      "helpTitle": "What does this node do?",
      "hideMiniMap": "Hide mini map",
      "insertAsOptionalGroup": "Insert as optional group",
      "insertTemplate": "Insert template {{name}}",
      "insertTemplateAsOptionalGroup": "Insert {{name}} as optional group",
      ...
      "optionalGroupDefaultOff": "default off",
      "optionalGroupDefaultOn": "Enabled by default for new tasks",
      "optionalGroupEmptyHint": "Drag optional steps here",
      "optionalGroupNote": "Runs the steps inside this group once when the task enables it (seeded from this default), and skips them when disabled. Drop the optional steps into the region.",
      "optionalGroupStepLabel": "Optional step",
    ...
    "workflowOptionalSteps": {
      "title": "Optional steps",
      "triggerCount_one": "Steps: {{count}} selected",
      "triggerCount_other": "Steps: {{count}} selected",
      "triggerNone": "Steps: none"
    },
    "workflowSelector": {
    ...
    "workflowSwitcher": {
      ...
      "label": "Workflow",
      "merging": "Merging",
      "mergingTitle_one": "{{count}} merging",
      "mergingTitle_other": "{{count}} merging",
    ...
    "workflows": {
      ...
      "collapseSidebar": "Collapse workflow sidebar",
      ...
      "showSidebar": "Show workflow sidebar",
  ...
  "common": {
    ...
    "git": {
      "commentAvatarAlt": "{{author}} avatar",
      "commentBot": "Bot",
      "commentFilterAll": "All",
      "commentFilterBot": "Bot",
      "commentFilterHuman": "Human",
      "commentHuman": "Human",
      "commentNavAriaLabel": "Navigate comments",
      "commentNavPosition": "{{current}} / {{total}}",
      "commentNextAriaLabel": "Next comment",
      "commentPrevAriaLabel": "Previous comment",
      "commentsHeading": "Comments",
      "filterCommentsAriaLabel": "Filter comments by author type",
      "loadingComments": "Loading comments…",
      "noCommentBody": "(empty comment)",
      "noComments": "No comments",
      "noCommentsForFilter": "No comments match the filter"
    },
    "health": {
      "anomaly": {
    ...
    "setup": {
      ...
      "apiKeyUsage": {
        "fallback": "Used by agi to authenticate requests to this provider",
